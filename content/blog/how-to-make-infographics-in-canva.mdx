---
title: "Canva Infographic Maker: How to Make an Infographic in Canva"
description: "How to use the Canva infographic maker step by step — templates, sizing, export — plus its real limits and a faster AI way to get animated infographics."
...
# Canva Infographic Maker: How to Make an Infographic in Canva
...
## Is Canva a good infographic maker?
...
- **Animation is built in.** With the [animated infographic maker](/animated-infographic-maker) you can export not just PNG and SVG, but also GIF and MP4, so the same idea works as a static image *and* an animated explainer.
...
**Does Canva have an infographic maker?**

Yes. The Canva infographic maker is not a separate app — it is Canva's standard drag-and-drop editor plus a large library of infographic templates. You pick a template sized for infographics, replace the placeholder content, and export. The steps above walk through exactly that workflow.
...
**Can Canva make an infographic from text with AI?**

Canva's AI features can draft generic layouts from a prompt, but they are not built around structured content — processes, systems, timelines, and comparisons still need manual arranging. Tools designed for text-to-infographic generation, like [Infogiph](/infographic-maker), parse your actual text into a structured, editable diagram and can animate it.
