...
export default function PrivacyPolicyPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-20 prose prose-neutral prose-headings:font-semibold prose-headings:tracking-tight">
      ...
      <p className="lead">Last updated: April 15, 2026</p>

      <p>
        Infogiph (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) operates
        the infogiph.com website and AI infographic generation service. This
      ...
      <h3>Account data</h3>
      <p>
        When you sign up via Google or GitHub OAuth, we receive your name, email
        address, and profile picture. We do not receive or store your password.
      </p>
      <h3>Usage data</h3>
      <p>
      ...
      <p>
        ...
        (OpenRouter / Google Gemini) for processing. They are not stored on our
        servers after the request completes.
      </p>
      <h3>Analytics</h3>
      <p>
        We use privacy-friendly analytics (Plausible or equivalent) that do not
        use cookies and do not track individuals across sites.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Infrastructure providers</strong> (Vercel, Cloudflare, Google
          Firebase) — hosting, storage, and database.
        </li>
        <li>
      ...
      <p>
        ...
        environment variables, never in source code. OAuth tokens are managed by
        Better Auth with secure HTTP-only cookies.
      </p>
      ...
      <p>
        ...
        <a href="mailto:support@infogiph.com">support@infogiph.com</a> or visit
