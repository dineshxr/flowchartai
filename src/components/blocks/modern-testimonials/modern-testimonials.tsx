...
const testimonials = [
  {
    ...
    content:
      'FlowChart AI has revolutionized how we document our processes. What used to take hours now takes minutes. The AI understands exactly what we need.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      "The quality of flowcharts generated is incredible. Our team uses it for system architecture diagrams and it's become an essential tool in our workflow.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      'Perfect for creating user journey maps and business process flows. The AI suggestions are spot-on and save us so much time in client presentations.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      'As a designer, I love how clean and professional the output looks. It integrates perfectly into our design system and client deliverables.',
    rating: 5,
    useCase: 'UX Design',
  },
  {
    ...
    content:
      "We've streamlined our entire operations documentation with FlowChart AI. The team adoption was instant because it's so intuitive to use.",
    rating: 5,
    useCase: 'Operations',
  },
  {
    ...
    content:
      'Essential for pitch decks and investor presentations. The professional quality helps us communicate complex ideas clearly to stakeholders.',
    rating: 5,
...
const useCases = [
  ...
  },
  {
    ...
    description:
      'Create system architectures, user flows, and technical diagrams',
    icon: '💻',
  ...
  },
  {
    ...
    description:
      'Build learning materials, course structures, and knowledge maps',
    icon: '📚',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            From startups to enterprises, see how teams across industries use
            FlowChart AI
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Join the community of professionals who've transformed their
            workflow with FlowChart AI
          </p>
        </motion.div>
